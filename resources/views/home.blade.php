            ...
            <div class="row gx-5   justify-content-center">
                <div class="col-lg-6 ">
                    <div class="  text-center my-5">
                        <h1 class="display-5   fw-bolder text-white mb-2">LuzMaya</h1>
                        ...
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                            ...
                            <a class="btn btn-success btn-lg  me-sm-3" href="{{ route('ajqijab.index') }}">Contacte a un Sacerdote Maya</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 border-bottom" id="features">
        <div class="container px-5 my-5">
            <div class="row gx-5">
                ...
                <a target="_blank" href="http://www.url.edu.gt/PortalURL/Archivos/83/Archivos/Departamento%20de%20Investigaciones%20y%20publicaciones/Proyectos%20de%20Investigacion/El%20Calendario%20Sagrado%20Maya%20metodo%20para%20el%20computo%20de%20tiempo.pdf">Leer "El Calendario Sagrado Maya,
                    Método para el Cómputo del Tiempo" - Ajq'ij y Msc. Audelino Sac Coyoy </a>
                </div>
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-collection"></i></div>
                    <h2 class="h4 fw-bolder">¿Quienes son los Ajq'ijab?</h2>
