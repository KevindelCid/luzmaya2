...
<head>
  <link rel="shortcut icon" href="{{ asset('storage').'/faviconLuzMaya.png' }}" />
    <meta charset="utf-8">
    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light   ">
            <div class="container">
                   ...
                   <a href="{{ route('home') }}"> <img id="" class="nav-logo" src="{{ asset('storage').'/luzmayagtlogo.png' }}" width="120" alt=""></a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                 ...
                                 @if(Auth::user()->tipo == 39)
                                   <a class="dropdown-item" href="{{ route('cp') }}">
                                     {{ __("Solicitudes Ajq'ij") }}
                                 </a>
                                 @endif
