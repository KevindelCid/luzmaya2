@extends('layouts.app')
<title>Calcular el nawal de hoy</title>
@section('content')
...
<div class="form-group">
                ...
                <div class="cards-list">
                    ...
                    <div class="card normal" data-toggle="modal" data-target="#mncargador">
                        <div class="card_image"> 
                            <img alt="nawal cargador del año" hidden id="imgcargador" src="" />
                         </div>
                         <div class="carsur">
  ...
  <div class="card fecha r" data-toggle="modal" data-target="#mn">
    <div class="card_image"> 
        <img alt="Nawal de nacimiento" hidden id="imgfechan" src="" />
     </div>
     <div class="carsur">
    <div class="card_title ">
        <p id="nawalfecha"></p>
    ...
    <div class="card_titlec title-white">
        <p>Nawal de nacimiento</p>
                     ...
                     <div class="card normal" data-toggle="modal" data-target="#mimgSolar">
                        <div class="card_image"> 
                            <img alt="calendario agricola ab glifo" hidden id="imgsolar" src="" />
                         </div>
                         <div class="carsur">
                        <div class="card_title ">
                            <p id="nawalSolar"></p>
                ...
                <div class="cards-list">
                    ...
                    <div class="card normal" data-toggle="modal" data-target="#mnAEI">
                        <div class="card_image"> 
                            <img alt="nawal auxiliar de engendaramiento" hidden id="imgnAEI" src="" />
                         </div>
                         <div class="carsur">
                        <div class="card_title ">
                            <p id="nawalAEI"></p>
                    ...
                    <div class="card norte" data-toggle="modal" data-target="#mnE">
                        <div class="card_image">
                            <img alt="nawal de engendramiento" hidden id="imgnE" src="" />
                        </div>
                        <div class="carsur">
                    ...
                    <div class="card normal" data-toggle="modal" data-target="#mnAED">
                        <div class="card_image">
                            <img alt="nawal auxiliar de engendaramiento" hidden id="imgnAED" src="" />
                        </div>
                        <div class="carsur">
                        <div class="card_title ">
                            <p id="nawalAED"></p>
                    ...
                    <div class="card este" data-toggle="modal" data-target="#mnAI">
                        <div class="card_image">
                            <img alt="nawal auxiliar" hidden id="imgnAI" src="" />
                        </div>
                        <div class="carsur">
                        <div class="card_titlen ">
                            Este
                    ...
                    <div class="card fecha r" data-toggle="modal" data-target="#mn">
                        <div class="card_image">
                            <img alt="nawal calculado" hidden id="imgn" src="" />
                        </div>
                        <div class="carsur">
                        <div class="card_title ">
                            <p id="nawal"></p>
                    ...
                    <div class="card oeste" data-toggle="modal" data-target="#mnAD">
                        <div class="card_image">
                            <img alt="nawal auxiliar" hidden id="imgnAD" src="" />
                        </div>
                        <div class="carsur">
                        <div class="card_titlen ">
                            Oeste
                    ...
                    <div class="card normal" data-toggle="modal" data-target="#mnADI">
                        <div class="card_image">
                            <img alt="nawal auxiliar destino" hidden id="imgnADI" src="" />
                        </div>
                        <div class="carsur">
                        <div class="card_title ">
                            <p id="nawalADI"></p>
                    ...
                    {{-- aqui nawal DE DESTINO --}}


                    <div class="card sur" data-toggle="modal" data-target="#mnD">
                        <div class="card_image">
                            <img alt="nawal de destino" hidden id="imgnD" src="" />
                        </div>
                        <div class="carsur">
                    ...
                    <div class="card normal" data-toggle="modal" data-target="#mnADD">
                        <div class="card_image">
                            <img alt="nawal auxiliar de destino" hidden id="imgnADD" src="" />
                        </div>
                        <div class="carsur">
                        <div class="card_title ">
                            <p id="nawalADD"></p>
...
<div class="modal fade dark" id="mn" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title centrar">Nawal de nacimiento</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <img class="res" id="mimgSolarm" src="" width="950" alt="">
                            ...
                            <script src="{{ asset('js/hoy_1.0.1.js') }}"></script>
