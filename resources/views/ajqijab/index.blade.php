...
<a href="{{ route('soli') }}"><u>¿Es usted un Sacerdote Maya?</u>
</a>
@endif
...
<div id="obj1" class="col-md-12">
    <div class="box">
        ...
        <div class="row">    
  <h2>Contacte con un Sacerdote Maya (Ajq'ij)</h2><br>
<div class="col-md-4 form-group">
  <!--<small>Los sacerdotes mayas o Ajq'ij aparecen en orden de el más activo hasta el menos activo en la plataforma.</small>-->
